...
public interface ProductService {
	...
	public Page<Product>getAllProduct(String topLevel,String secondLevel,String thirdLevel,List<String>colors,List<String>sizes,Integer minPrice,Integer maxPrice,
